...
const MOCK_GATHERINGS = [
  {
    id: 1,
    title: '강남 · 07.15 · 인사이드 아웃 3',
    movie: '인사이드 아웃 3',
    place: '롯데시네마 강남',
    time: '7월 15일 (화) 오후 7:30',
    current: 3, max: 6, distance: '1.2km',
  },
  {
    id: 2,
    title: '홍대 · 07.16 · 범죄도시 5',
    movie: '범죄도시 5',
    place: 'CGV 홍대',
    time: '7월 16일 (수) 오후 2:00',
    current: 2, max: 4, distance: '2.5km',
  },
  {
    id: 3,
    title: '신촌 · 07.18 · 퀸 클래식 음악회',
    movie: '퀸 클래식 음악회',
    place: '연세대 대강당',
    time: '7월 18일 (금) 오후 6:00',
    current: 5, max: 8, distance: '3.8km',
  },
  {
    id: 4,
    title: '종로 · 07.20 · 이상한 나라의 수학자',
    movie: '이상한 나라의 수학자 (독립)',
    place: '인디스페이스',
    time: '7월 20일 (일) 오후 4:00',
    current: 1, max: 4, distance: '5.1km',
  },
  {
    id: 5,
    title: '강동 · 07.22 · 라라랜드 재개봉',
    movie: '라라랜드 (재개봉)',
    place: 'CGV 강동',
    time: '7월 22일 (화) 오후 8:00',
    current: 4, max: 6, distance: '6.3km',
  },
];
          ...
          <CardContent sx={{ pb: '16px !important' }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
              <Chip
                ...
                label={`${g.current}/${g.max}명`}
                size="small"
                sx={{ bgcolor: '#F5ECD7', color: '#8B6347', fontWeight: 700 }}
              />
